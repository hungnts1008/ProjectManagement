...
public class FrameLogIn extends javax.swing.JFrame {
    ...
    public FrameLogIn() {
        initComponents();
        setTitle("PROJECT MANAGEMENT PROGRAM");
    ...
    private void checkLogIn() {
        ...
        char[] tempPassWord = tfMatKhau.getPassword();
        String passWord = new String(tempPassWord);
        // System.out.println("hungdeptrai " + logInManagement.logIn(userName,
        // passWord));
        if (userName.length() == 0 || passWord.length() == 0) {
            JOptionPane.showMessageDialog(null, "Tên đăng nhập hoặc mật khẩu không được để trống", "Thông báo",
                    JOptionPane.INFORMATION_MESSAGE);
        } else if (logInManagement.logIn(userName, passWord) == 1) {
            logInManagement.LogIn(1, userName);
            this.setVisible(false);
        } else if (logInManagement.logIn(userName, passWord) == 2) {
            logInManagement.LogIn(2, userName);
            this.setVisible(false);
        } else {
            JOptionPane.showMessageDialog(null, "Sai tên đăng nhập hoặc mật khẩu", "Thông báo",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        // jLabel2.setIcon(new
        // javax.swing.ImageIcon(getClass().getResource("/icon/login.png"))); // NOI18N
        jLabel2.setText(" ");
        ...
        // jLabel1.setIcon(new
        // javax.swing.ImageIcon(getClass().getResource("/icon/key.png"))); // NOI18N
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(tfTenDangNhap, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(tfMatKhau, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap(36, Short.MAX_VALUE)));

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        // jButton1.setIcon(new
        // javax.swing.ImageIcon(getClass().getResource("/icon/login 1.png"))); //
        // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 117,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(201, 201, 201)));
